import { getSurah } from '@/utils/apis';
...
const SurahCard = ({
  ...
  return (
    <>
      <div
        className={`group w-full h-full flex justify-start px-3 gap-3 items-center shadow-lg mt-2 bg-white rounded-lg ${
          center
            ? 'justify-center'
